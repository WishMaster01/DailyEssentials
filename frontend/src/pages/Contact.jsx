        ...
        <div>
            <div class="max-w-5xl w-full mx-auto p-10 text-gray-800">
                ...
                <p class="text-left mt-4">
                    ...
                    <a href="mailto:contact@example.com" class="text-primary"> dailyessentials@Support.com</a>
                </p>
                <div class="grid md:grid-cols-3 mt-16">
                    <div>
                        <svg class="text-primary bg-primary/20 p-2.5 aspect-square rounded-full size-10" width="24"
                        ...
                        <a href="mailto:support@example.com" class="text-primary font-semibold">
                            dailyessentials@Support.com
                        </a>
                    </div>
                    <div>
                        <svg class="text-primary bg-primary/20 p-2.5 aspect-square rounded-full size-10" width="24"
                        ...
                        <span class="text-primary font-semibold">
                            NH-12, Tonk Road, Chaksu, JAIPUR
                        </span>
                    </div>
                    <div>
                        <svg class="text-primary bg-primary/20 p-2.5 aspect-square rounded-full size-10" width="21"
